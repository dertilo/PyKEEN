...
from pykeen.cli.utils import (
    ...
    configure_trans_e_hpo_pipeline,
    configure_trans_e_training_pipeline,
    configure_trans_h_hpo_pipeline,
    configure_trans_h_training_pipeline,
    configure_trans_r_hpo_pipeline,
    configure_trans_r_training_pipeline,
...
__all__ = ["MODEL_TRAINING_CONFIG_FUNCS", "MODEL_HPO_CONFIG_FUNCS"]
