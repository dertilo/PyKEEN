...
from pykeen.constants import (
    ...
    ENTITIES_EMBEDDING_DIMENSION_PROMPT_MSG,
    EPOCHS_ERROR_MSG,
    EPOCHS_PRINT_MSG,
    EPOCHS_PROMPT_MSG,
    EPOCH_ERROR_MSG,
    ...
    RELATION_EMBEDDING_DIMENSIONS_PROMPT_MSG,
...
__all__ = ["configure_trans_r_hpo_pipeline", "configure_trans_r_training_pipeline"]


def configure_trans_r_training_pipeline(model_name: str):
