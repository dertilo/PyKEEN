...
from pykeen.constants import (
    ...
    ENTITIES_NORMALIZATION_PRINT_MSG,
    ENTITIES_NORMALIZATION_PROMPT_MSG,
    EPOCHS_ERROR_MSG,
    EPOCHS_PRINT_MSG,
    EPOCHS_PROMPT_MSG,
    EPOCH_ERROR_MSG,
    ...
    NORMS_FOR_NORMALIZATION_OF_ENTITIES_PROMPT_MSG,
...
__all__ = ["configure_trans_e_hpo_pipeline", "configure_trans_e_training_pipeline"]


def configure_trans_e_training_pipeline(model_name: str):
