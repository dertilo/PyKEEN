...
TRAINING_FILE_ERROR_MSG = (
    "An error occurred, either the path is not correct or the training file doesn't exist.\n"
    "Please try again."
)

TEST_FILE_PROMPT_MSG = "> Please provide here the path to your test file: "
TEST_FILE_ERROR_MSG = (
    "An error occurred, either the path is not correct or the test file doesn't exist.\n"
    "Please try again."
)

EMBEDDING_DIMENSION_PRINT_MSG = (
    "Please type the range of preferred embedding dimensions for entities comma-separated"
    " (e.g. 50,100,200):"
)
EMBEDDING_DIMENSION_PROMPT_MSG = "> Please select the embedding dimensions:"
EMBEDDING_DIMENSION_ERROR_MSG = (
    "An error occurred, please positive integer as embedding dimension."
)

ENTITIES_EMBEDDING_DIMENSION_PRINT_MSG = (
    "Please provide the embedding dimension for entities (e.g. 40). "
)
ENTITIES_EMBEDDING_DIMENSION_PROMPT_MSG = "> Entity embedding dimension: "
ENTITIES_EMBEDDING_DIMENSION_ERROR_MSG = (
    "An error occurred, please proive and positive integer as embedding dimension"
    " (e.g. 50)."
)

ENTITIES_EMBEDDING_DIMENSIONS_PRINT_MSG = (
    "Please provide (comma separated) the embedding dimension(s) for entities"
    " (e.g. 50, 100). "
)
ENTITIES_EMBEDDING_DIMENSIONS_PROMPT_MSG = "> Entity embedding dimensions: "
ENTITIES_EMBEDDING_DIMENSIONS_ERROR_MSG = (
    "An error occurred, the embedding dimensions must be positive integers and"
    " separated by a comma.\nPlease try again."
)

BATCH_SIZES_PRINT_MSG = (
    "Please type (comma separated) the batch size(s) (e.g. 32, 64, 128):"
)
BATCH_SIZES_PROMPT_MSG = "> Batch size(s): "
BATCH_SIZES_ERROR_MSG = (
    "An error occurred, the batch sizes must be positive integers and separated by a comma.\n"
    "Please try again."
)

EPOCHS_PRINT_MSG = (
    "Please type (comma separated) the number of epochs (e.g. 50, 100, 500)."
)
EPOCHS_PROMPT_MSG = "> Epochs: "
EPOCHS_ERROR_MSG = (
    "An error occurred, the number of epochs must be positive integers and separated by a comma.\n"
    "Please try again."
)

LEARNING_RATES_PRINT_MSG = (
    "Please type (comma separated) the learning rate(s) (e.g. 0.1, 0.01, 0.0001)."
)
LEARNING_RATES_PROMPT_MSG = "> Learning rate(s): "
LEARNING_RATES_ERROR_MSG = (
    "An error occurred, the learning rates must be float values and separated by a comma.\n"
    "Please try again."
)

MARGIN_LOSSES_PRINT_MSG = (
    "Please type (comma separated) the margin losses(s) comma separated (e.g. 1, 2, 10),"
    " and press enter."
)
MARGIN_LOSSES_PROMPT_MSG = "> Margin losse(s): "
MARGIN_LOSSES_ERROR_MSG = (
    "An error occurred, the margin losses must be positive float values and separated by a"
    " comma (e.g. 0.5, 3)"
)
...
EMBEDDING_DIMENSION_PRINT_MSG = (
    "Please provide the embedding dimension of entities and relations, and press enter."
)
...
EMBEDDING_DIMENSIONS_PRINT_MSG = (
    "Please provide (comma separated) the embedding dimension(s), and press enter."
)
EMBEDDING_DIMENSIONS_PROMPT_MSG = "> Embedding dimensions: "
EMBEDDING_DIMENSIONS_ERROR_MSG = (
    "An error occurred, the embedding dimensions must be positive integers and separated\n"
    "by a comma e.g. 50,100,200"
    "Please try again. \n"
)

RELATION_EMBEDDING_DIMENSION_PRINT_MSG = (
    "Please provide the embedding dimension of relations:"
)
RELATION_EMBEDDING_DIMENSION_PROMPT_MSG = "> Relation embedding dimension: "
RELATION_EMBEDDING_DIMENSION_ERROR_MSG = (
    "An error occurred, please type in an integer as embedding dimension such" " as 30."
)

RELATION_EMBEDDING_DIMENSIONS_PRINT_MSG = (
    "Please provide (comma separated) the embedding dimensions of relations:"
)
RELATION_EMBEDDING_DIMENSIONS_PROMPT_MSG = "> Relation embedding dimensions: "
RELATION_EMBEDDING_DIMENSIONS_ERROR_MSG = (
    "An error occurred, the relation embedding dimensions must be positive"
...
LEARNING_RATE_ERROR_MSG = (
    "An error occurred, the learning rate should be a positive float value.\n"
    "Please try again."
)
...
SEED_ERROR_MSG = (
    "An error occurred, please proive and positive integer as the random seed."
)
...
ENTITIES_NORMALIZATION_ERROR_MSG = (
    "An error occurred, the norm should be an integer greater than 0, such as 1\n"
    "Please try again."
)
...
NORMS_FOR_NORMALIZATION_OF_ENTITIES_ERROR_MSG = (
    "An error occurred, the normalization norms should integers, greater than 0, \n"
...
NORM_SCORING_FUNCTION_ERROR_MSG = (
    "An error occurred, the norm for the scoring function should be an integer greater than 0, such as 1\n"
    "Please try again."
)
...
NORMS_SCORING_FUNCTION_ERROR_MSG = (
    "An error occurred, the norms for the scoring functions should integers, greater than 0, \n"
    " and separated by a comma (e.g. 1, 2, 3). Please try again."
)
...
CONV_E_HPO_INPUT_CHANNELS_PRINT_MSG = (
    "Please select (comma separated) the number of input channels for ConvE"
)
CONV_E_HPO_INPUT_CHANNELS_PROMPT_MSG = "> Input channels:"
CONV_E_HPO_INPUT_CHANNELS_ERROR_MSG = (
    "An error occurred, input channels must be positive integers."
)
...
CONV_E_INPUT_CHANNEL_ERROR_MSG = (
    "An error occurred, the number of input channels must be a positive integer.\n"
    "Please try again."
)

CONV_E_HPO_OUT_CHANNELS_PRINT_MSG = (
    "Please select (comma separated) the number of output channels for ConvE"
)
CONV_E_HPO_OUT_CHANNELS_PROMPT_MSG = "> Output channels:"
CONV_E_HPO_OUT_CHANNELS_ERROR_MSG = (
    "An error occurred, output channels must be positive integers."
)
...
CONV_E_OUT_CHANNEL_ERROR_MSG = (
    "An error occurred, the number of output channels must be a positive number."
)
...
CONV_E_HPO_KERNEL_WIDTHS_PRINT_MSG = (
    "Please select the wifth for the convolution kernel."
)
...
CONFIG_FILE_PROMPT_MSG = (
    "> Please provide the path to your existing configuration file: "
)
CONFIG_FILE_ERROR_MSG = (
    "An error occurred, please make sure that the file exists, and that it is JSON file.\n"
    "Please try again."
)

CONV_E_HPO_INPUT_DROPOUTS_PRINT_MSG = (
    "Please select (comma separated) the input dropout value(s)"
)
CONV_E_HPO_INPUT_DROPOUTS_PROMPT_MSG = "> Input dropout value(s): "
CONV_E_HPO_INPUT_DROPOUTS_ERROR_MSG = (
    "An error occurred, input must be positive float values."
)
...
CONV_E_HPO_OUTPUT_DROPOUT_PRINT_MSG = (
    "Please select (comma separated) the output dropout value(s)"
)
...
CONV_E_HPO_FEATURE_MAP_DROPOUT_PRINT_MSG = (
    "Please select (comma separated) the feature map dropout value(s)"
)
...
CONV_E_FEATURE_MAP_DROPOUT_ERROR_MSG = (
    "Invalid output, input must be a positive float value."
)

WEIGHT_SOFT_CONSTRAINT_TRANS_H_PRINT_MSG = (
    "Please select the weight value for the soft constraints of" " the loss function"
)
WEIGHT_SOFT_CONSTRAINT_TRANS_H_PROMPT_MSG = "> Weight value for soft constraints: "
WEIGHT_SOFT_CONSTRAINT_TRANS_H_ERROR_MSG = (
    "An error occurred, input must be positive a float value."
)

WEIGHTS_SOFT_CONSTRAINT_TRANS_H_PRINT_MSG = (
    "Please provide (comma separated) the weight values for weighting the"
...
WEIGHTS_SOFT_CONSTRAINT_TRANS_H_ERROR_MSG = (
    "An error occurred, the weight values for the soft constraint must be"
